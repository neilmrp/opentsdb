...
//                    }
                    ...
                    if (buildIterator == null) {
                        ...
                        if (curr.getType().equals(NumericType.TYPE)) {
                            ((PBufNumericTimeSeriesSerdes) serdes).serializeGivenTimes(currentTsBuilder, context, options, result, buildIterator,
...
//            }
            ...
            results.add(new PBufQueryResult(factory, node, null, pbufBlockBuilder.build()));
